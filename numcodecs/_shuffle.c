...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "numcodecs._shuffle",
        "sources": [
            "numcodecs/_shuffle.pyx"
        ]
    },
    "module_name": "numcodecs._shuffle"
}
END: Cython Metadata */
...
#define __PYX_HAVE__numcodecs___shuffle
#define __PYX_HAVE_API__numcodecs___shuffle
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'numcodecs._shuffle' */
...
static void __pyx_f_9numcodecs_8_shuffle__doShuffle(__Pyx_memviewslice, __Pyx_memviewslice, Py_ssize_t, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_9numcodecs_8_shuffle__doUnshuffle(__Pyx_memviewslice, __Pyx_memviewslice, Py_ssize_t, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "numcodecs._shuffle"
extern int __pyx_module_is_main_numcodecs___shuffle;
int __pyx_module_is_main_numcodecs___shuffle = 0;

/* Implementation of 'numcodecs._shuffle' */
...
static PyObject *__pyx_pf_9numcodecs_8_shuffle__doShuffle(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_des, Py_ssize_t __pyx_v_element_size); /* proto */
static PyObject *__pyx_pf_9numcodecs_8_shuffle_2_doUnshuffle(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_des, Py_ssize_t __pyx_v_element_size); /* proto */
...
static PyObject *__pyx_pw_9numcodecs_8_shuffle_1_doShuffle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_9numcodecs_8_shuffle__doShuffle(__Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_des, Py_ssize_t __pyx_v_element_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_src); 
  if (unlikely(__pyx_v_element_size == 0)) {
    #ifdef WITH_THREAD
  ...
  else if (sizeof(Py_ssize_t) == sizeof(long) && (!(((Py_ssize_t)-1) > 0)) && unlikely(__pyx_v_element_size == (Py_ssize_t)-1)  && unlikely(UNARY_NEG_WOULD_OVERFLOW(__pyx_t_1))) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
 ...
 */
    __pyx_v_offset = (__pyx_v_i * __pyx_v_element_size);

    /* "numcodecs/_shuffle.pyx":16
 *     for i in range(count):
 *         offset = i*element_size
 *         for byte_index in range(element_size):             # <<<<<<<<<<<<<<
 *             j = byte_index*count + i
 ...
 */
    __pyx_t_5 = __pyx_v_element_size;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_byte_index = __pyx_t_7;

      /* "numcodecs/_shuffle.pyx":17
 *         offset = i*element_size
 *         for byte_index in range(element_size):
 *             j = byte_index*count + i             # <<<<<<<<<<<<<<
 *             des[j] = src[offset + byte_index]
 * 
 */
      __pyx_v_j = ((__pyx_v_byte_index * __pyx_v_count) + __pyx_v_i);

      /* "numcodecs/_shuffle.pyx":18
 *         for byte_index in range(element_size):
 *             j = byte_index*count + i
 *             des[j] = src[offset + byte_index]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_9 = __pyx_v_j;
      *((unsigned char *) ( /* dim=0 */ ((char *) (((unsigned char *) __pyx_v_des.data) + __pyx_t_9)) )) = (*((unsigned char const  *) ( /* dim=0 */ ((char *) (((unsigned char const  *) __pyx_v_src.data) + __pyx_t_8)) )));
    }
  }
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("numcodecs._shuffle._doShuffle", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* Python wrapper */
static PyObject *__pyx_pw_9numcodecs_8_shuffle_1_doShuffle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9numcodecs_8_shuffle__doShuffle[] = "_doShuffle(const unsigned char[::1] src, unsigned char[::1] des, Py_ssize_t element_size) -> void";
static PyObject *__pyx_pw_9numcodecs_8_shuffle_1_doShuffle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_src = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_des = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_element_size;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_doShuffle (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_src,&__pyx_n_s_des,&__pyx_n_s_element_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_des)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_doShuffle", 1, 3, 3, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_element_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_doShuffle", 1, 3, 3, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_doShuffle") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_src = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_char__const__(values[0], 0); if (unlikely(!__pyx_v_src.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_des = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_des.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_element_size = __Pyx_PyIndex_AsSsize_t(values[2]); if (unlikely((__pyx_v_element_size == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_doShuffle", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("numcodecs._shuffle._doShuffle", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9numcodecs_8_shuffle__doShuffle(__pyx_self, __pyx_v_src, __pyx_v_des, __pyx_v_element_size);
...
static PyObject *__pyx_pf_9numcodecs_8_shuffle__doShuffle(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_des, Py_ssize_t __pyx_v_element_size) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_doShuffle", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_src.memview)) { __Pyx_RaiseUnboundLocalError("src"); __PYX_ERR(0, 11, __pyx_L1_error) }
  if (unlikely(!__pyx_v_des.memview)) { __Pyx_RaiseUnboundLocalError("des"); __PYX_ERR(0, 11, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_9numcodecs_8_shuffle__doShuffle(__pyx_v_src, __pyx_v_des, __pyx_v_element_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_des, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "numcodecs/_shuffle.pyx":23
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static PyObject *__pyx_pw_9numcodecs_8_shuffle_3_doUnshuffle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_9numcodecs_8_shuffle__doUnshuffle(__Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_des, Py_ssize_t __pyx_v_element_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_count;
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_offset;
 ...
 */
  __pyx_t_2 = __pyx_v_element_size;
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "numcodecs/_shuffle.pyx":27
 *     count = len(src) // element_size
 *     for i in range(element_size):
 *         offset = i*count             # <<<<<<<<<<<<<<
 *         for byte_index in range(count):
 ...
 */
    __pyx_v_offset = (__pyx_v_i * __pyx_v_count);

    /* "numcodecs/_shuffle.pyx":28
 *     for i in range(element_size):
 *         offset = i*count
 *         for byte_index in range(count):             # <<<<<<<<<<<<<<
 *             j = byte_index*element_size + i
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("numcodecs._shuffle._doUnshuffle", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* Python wrapper */
static PyObject *__pyx_pw_9numcodecs_8_shuffle_3_doUnshuffle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9numcodecs_8_shuffle_2_doUnshuffle[] = "_doUnshuffle(const unsigned char[::1] src, unsigned char[::1] des, Py_ssize_t element_size) -> void";
static PyObject *__pyx_pw_9numcodecs_8_shuffle_3_doUnshuffle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_src = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_des = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_element_size;
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_doUnshuffle (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_src,&__pyx_n_s_des,&__pyx_n_s_element_size,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_des)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_doUnshuffle", 1, 3, 3, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_element_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_doUnshuffle", 1, 3, 3, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_doUnshuffle") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_src = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_char__const__(values[0], 0); if (unlikely(!__pyx_v_src.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_des = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_des.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_element_size = __Pyx_PyIndex_AsSsize_t(values[2]); if (unlikely((__pyx_v_element_size == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_doUnshuffle", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("numcodecs._shuffle._doUnshuffle", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9numcodecs_8_shuffle_2_doUnshuffle(__pyx_self, __pyx_v_src, __pyx_v_des, __pyx_v_element_size);
...
static PyObject *__pyx_pf_9numcodecs_8_shuffle_2_doUnshuffle(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_src, __Pyx_memviewslice __pyx_v_des, Py_ssize_t __pyx_v_element_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_doUnshuffle", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_src.memview)) { __Pyx_RaiseUnboundLocalError("src"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_des.memview)) { __Pyx_RaiseUnboundLocalError("des"); __PYX_ERR(0, 23, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_9numcodecs_8_shuffle__doUnshuffle(__pyx_v_src, __pyx_v_des, __pyx_v_element_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "numcodecs._shuffle.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "numcodecs._shuffle.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "numcodecs._shuffle.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "numcodecs._shuffle._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_doShuffle", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9numcodecs_8_shuffle_1_doShuffle, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9numcodecs_8_shuffle__doShuffle},
  {"_doUnshuffle", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9numcodecs_8_shuffle_3_doUnshuffle, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9numcodecs_8_shuffle_2_doUnshuffle},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__shuffle(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__shuffle},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_shuffle(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_shuffle(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__shuffle(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__shuffle(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__shuffle(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_shuffle' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__shuffle(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_shuffle", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_numcodecs___shuffle) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "numcodecs._shuffle")) {
      if (unlikely(PyDict_SetItemString(modules, "numcodecs._shuffle", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init numcodecs._shuffle", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init numcodecs._shuffle");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
